...
public class FensImporter
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        try
        {
            ...
            dataRecordSet.RootFolder = filePath.toLowerCase().endsWith(".zip") ? UnzipFiles.UnzipAndCopyLocal(filePath) : new File(filePath);

            if (dataRecordSet.RootFolder == null)
            {
            ...
            dataRecordSet.OutFileType.Hostname = hostname;
            ...
            {
                DataManager.ExportHistogram(dataRecordSet.RootFolder, recordSetList);
            }
            else
            {
